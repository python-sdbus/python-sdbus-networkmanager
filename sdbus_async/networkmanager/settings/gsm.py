...
class GsmSettings(NetworkManagerSettingsMixin):
    ...
    which this connection applies to.  If given, the connection will only apply to
    ...
    which this connection applies to.  If given, the connection will apply to any
    device also allowed by "device-id" which contains a SIM card matching the
    given identifier."""
