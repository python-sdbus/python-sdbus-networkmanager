...
class DcbSettings(NetworkManagerSettingsMixin):
    ...
    """Specifies the NMSettingDcbFlags for the DCB iSCSI application.  Flags may
    ...
    bandwidth allocated to that group.  Allowed values are 0 - 100, and the sum of
    all values must total 100 percents."""
