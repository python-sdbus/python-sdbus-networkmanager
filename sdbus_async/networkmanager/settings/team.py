...
class TeamSettings(NetworkManagerSettingsMixin):
    ...
    mcast_rejoin_count: Optional[int] = field(
        metadata={'dbus_name': 'mcast-rejoin-count', 'dbus_type': 'i'},
        default=None,
    )
    mcast_rejoin_interval: Optional[int] = field(
        metadata={'dbus_name': 'mcast-rejoin-interval', 'dbus_type': 'i'},
        default=None,
    )
    notify_peers_count: Optional[int] = field(
        metadata={'dbus_name': 'notify-peers-count', 'dbus_type': 'i'},
        default=None,
    )
    notify_peers_interval: Optional[int] = field(
        metadata={'dbus_name': 'notify-peers-interval', 'dbus_type': 'i'},
        default=None,
    )
    ...
    runner_agg_select_policy: Optional[str] = field(
        metadata={'dbus_name': 'runner-agg-select-policy', 'dbus_type': 's'},
        default=None,
    )
    runner_fast_rate: Optional[bool] = field(
        metadata={'dbus_name': 'runner-fast-rate', 'dbus_type': 'b'},
        default=False,
    )
    runner_hwaddr_policy: Optional[str] = field(
        metadata={'dbus_name': 'runner-hwaddr-policy', 'dbus_type': 's'},
        default=None,
    )
    runner_min_ports: Optional[int] = field(
        metadata={'dbus_name': 'runner-min-ports', 'dbus_type': 'i'},
        default=None,
    )
    runner_sys_prio: Optional[int] = field(
        metadata={'dbus_name': 'runner-sys-prio', 'dbus_type': 'i'},
        default=None,
    )
    runner_tx_balancer: Optional[str] = field(
        metadata={'dbus_name': 'runner-tx-balancer', 'dbus_type': 's'},
        default=None,
    )
    runner_tx_balancer_interval: Optional[int] = field(
        metadata={'dbus_name': 'runner-tx-balancer-interval', 'dbus_type': 'i'},
        default=None,
    )
    runner_tx_hash: Optional[List[str]] = field(
        metadata={'dbus_name': 'runner-tx-hash', 'dbus_type': 'as'},
        default=None,
    )
