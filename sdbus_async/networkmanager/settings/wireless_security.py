...
class WirelessSecuritySettings(NetworkManagerSettingsMixin):
    ...
    LEAP (ie, key-mgmt = "ieee8021x" and auth-alg = "leap") the "leap-username"
    ...
    global default value), NM_SETTING_WIRELESS_SECURITY_FILS_DISABLE (1) (disable
    FILS), NM_SETTING_WIRELESS_SECURITY_FILS_OPTIONAL (2) (enable FILS if the
    supplicant and the access point support it) or
    NM_SETTING_WIRELESS_SECURITY_FILS_REQUIRED (3) (enable FILS and fail if not
    supported).  When set to NM_SETTING_WIRELESS_SECURITY_FILS_DEFAULT (0) and no
    ...
    to Wi-Fi networks that do not utilize one of the algorithms in the list.  For
    ...
    only). This property must be set for any Wi-Fi connection that uses
    security."""
    ...
    """A list of pairwise encryption algorithms which prevents connections to Wi-
    ...
    determine whether it's feasible to start WPS enrollment from the Access Point
